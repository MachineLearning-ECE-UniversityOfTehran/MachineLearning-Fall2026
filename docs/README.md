...
> [!IMPORTANT]
> **eLearn is the authoritative announcement channel.** If an operational detail changes after a document is published, the latest official announcement takes precedence until the repository is updated.

## Documentation principles

Course documentation is maintained to be clear, versioned, consistent, and easy to navigate. Important public changes remain visible in Git history, and README summaries point back to the relevant detailed documents.

---

<p align="center"><sub>One course · One organized public hub · Changes tracked in Git</sub></p>
